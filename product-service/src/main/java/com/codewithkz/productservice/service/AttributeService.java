...
public interface AttributeService extends BaseService<Attribute, AttributeCreateUpdateRequestDTO, String> {
    List<AttributeValue> createAttributeValueList(Product product, List<AttributeDTO> attributes, Map<String, Attribute> attributeMap, Map<String, AttributeValue> attributeValueMap);
}
