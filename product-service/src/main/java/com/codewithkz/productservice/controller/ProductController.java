...
@Slf4j
public class ProductController extends BaseController<Product, ProductCreateUpdateRequestDTO, ProductCreateUpdateResponseDTO, ProductCreateUpdateRequestDTO, String> {
